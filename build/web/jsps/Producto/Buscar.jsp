...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="mainbar">
                <div class="page-head">
                    <h2 class="pull-left"><i class="icon-table"></i> Avaluos</h2>
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <div class="widget-foot">
                                            ...
                                            <ul class="pagination pull-right">
                                                ...
                                                <li><a href="Buscar.jsp?i=<%=auxinicio%>&f=<%=inicio%>&columna=<%=columna%>&valor=<%=valor%>">Atras</a></li>

                                                <li><a href="Buscar.jsp?i=<%=fin%>&f=<%=auxfin%>&columna=<%=columna%>&valor=<%=valor%>">Siguiente</a></li>
                                            </ul>
