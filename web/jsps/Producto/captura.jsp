                            ...
                            <div class="col-md-7" id="venPrincipal">
                                ...
                                <div class="widget">
                                    <div class="widget-head">
                                        <div class="pull-left">Nuevo Avalúo PASO 2</div>
                                                    ...
                                                    <form class="form-horizontal" action="../../Agregar" method="POST">
                                                        ...
                                                        <div id="datos" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <input type="text" maxlength="4" name="ano" onkeypress="return isNumberKey(event)" class="form-control" placeholder="AÑO" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
